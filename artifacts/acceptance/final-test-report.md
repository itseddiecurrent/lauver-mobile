...
| iOS archive/export | `artifacts/acceptance/step-15-production-build4-archive-20260921.log`, `artifacts/acceptance/step-15-production-build4-export-20260921.log` | Production archive and App Store Connect export succeeded for `ai.lauver.app.release` build `1.0.0 (4)`; IPA is Apple Distribution signed with Store profile, HealthKit/Photo Library/Microphone/Camera purpose strings, complete iPhone/marketing icons, and Sign in with Apple entitlements |
