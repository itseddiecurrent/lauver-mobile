...
| iOS archive/export | `artifacts/acceptance/step-15-production-build2-archive-20260921.log`, `artifacts/acceptance/step-15-production-build2-export-20260921.log` | Production archive and App Store Connect export succeeded for `ai.lauver.app.release` build `1.0.0 (2)`; IPA is Apple Distribution signed with Store profile, both required HealthKit purpose strings, and Sign in with Apple entitlements |
