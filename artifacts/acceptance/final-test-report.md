...
| iOS archive/export | `artifacts/acceptance/step-15-production-build3-archive-20260921.log`, `artifacts/acceptance/step-15-production-build3-export-20260921.log` | Production archive and App Store Connect export succeeded for `ai.lauver.app.release` build `1.0.0 (3)`; IPA is Apple Distribution signed with Store profile, both required HealthKit purpose strings, complete iPhone/marketing icons, and Sign in with Apple entitlements |
